...
Here it is Chat bot project used LangChain Framework and integration with  Groq API  used Flask API login with Magic Mail Link 
...
Core RAG logic, embeddings, and LLM integration.
database.py:

SQLite database management for users and chat history.

mail_utils.py:

Magic link generation and email logic.
prompts.yml:

Configurable system prompts and templates.
policy/:

Directory for source policy documents.
